...
class User(UserMixin, db.Model):
    ...
    def __init__(self, **kwargs):  # 赋予角色权限
    ...
    def generate_confirmtion_token(self, expiration=3600):  # 3600s =1h
    ...
    def generate_reset_token(self, expiration=3600):
        s = Serializer(current_app.config['SECREZT_KEY'], expiration)
